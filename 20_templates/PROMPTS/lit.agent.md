...
A multimodal, versioned markdown system prompt standard for autonomous literature review agents. Modular, extensible, and optimized for composability, auditability, and transparent reasoning—suitable for agentic and human collaboration.
...
### 2. Literature Review Workflow (YAML)
