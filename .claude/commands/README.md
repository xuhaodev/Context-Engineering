...
This directory contains a collection of modular, extensible agentic command harnesses designed for enhancing the capabilities of [Claude Code](https://www.anthropic.com/claude-code) and other compatible agentic systems, such as [OpenCode](https://github.com/sst/opencode), [Amp](https://sourcegraph.com/amp), or [Gemini CLI](https://github.com/google-gemini/gemini-cli). Each command implements a specialized agent protocol with consistent structure, enabling sophisticated context engineering across various domains.
