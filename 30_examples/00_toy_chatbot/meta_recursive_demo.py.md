...
- **Resonance Score** (blue): How well patterns in the field resonate with each other
- **Coherence Score** (green): Overall coherence of responses and field state
- **Field Coherence** (purple): Internal coherence of the context field
- **Field Stability** (orange): Stability of attractors in the field
