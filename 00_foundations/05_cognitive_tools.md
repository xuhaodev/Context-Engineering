...
> **These cognitive tools (structured prompt templates as reasoning tool calls) break down the problem by identifying the main concepts at hand, extracting relevant information in the question, and highlighting meaningful properties, theorems, and techniques that
...
**Reflective Exercise**: Look at your recent AI conversations. Can you identify implicit structures you've been using (ie. emotional context, underlying intent, long horizon goals, clarifying data, etc)? How might formalizing these into protocol shells improve your interactions?
